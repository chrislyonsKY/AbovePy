...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p_package.add_argument("--no-preview", action="store_true", default=False, help="Skip preview image")
    p_package.add_argument("--no-qgis", action="store_true", default=False, help="Skip QGIS project")
    p_package.add_argument("--no-checksums", action="store_true", default=False, help="Skip SHA-256 checksums")
